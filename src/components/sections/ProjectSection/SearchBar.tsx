...
function SearchBar() {
    ...
    return (
        <div className="bg-primary dark:bg-primary-dark text-white mx-auto flex flex-col md:flex-row gap-[1rem] shadow-lg p-[1rem] w-[35rem] md:w-[45rem]  lg:w-[65rem] rounded-[.5rem]">
